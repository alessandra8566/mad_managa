...
<script>
  export default {
    ...
    methods: {
      init() {
        var thunder = document.getElementsByClassName('thunder-bg')[0];
        ...
        var w = canvas1.width = canvas2.width = canvas3.width = thunder.offsetWidth;
        var h = canvas1.height = canvas2.height = canvas3.height = thunder.offsetHeight;
        window.addEventListener('resize', function () {
          w = canvas1.width = canvas2.width = canvas3.width = thunder.offsetWidth;
          h = canvas1.height = canvas2.height = canvas3.height = thunder.offsetHeight;
        });
